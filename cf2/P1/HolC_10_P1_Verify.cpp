...
{ //***main
  ...
  ofstream logfile, myfile;
     ...
     //********************************************************************
  logfile.open ("/home/pwb0013/csce2110/program1/2110_001_class_log.txt", ios::out | ios::app);
  ...
  if (logfile.is_open())
    ...
    {    // could not open shared file ... report and exit
     cout << "***** ERROR:  Unable to open 2110_001_class_log.txt *****" << endl;
     return 0;
    }
  ...
  if (log_complete == 1)
    {
     myfile.open ("CSCE2110_001_Program1_Verification.txt", ios::trunc);

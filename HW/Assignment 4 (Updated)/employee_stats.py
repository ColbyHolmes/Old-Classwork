...
if sys.argv[2] == '1': #LIST ALPHA
  ...
  for i in range(len(employeelist)):
    ...
    print "Name: ", employeelist[i].first, " ", employeelist[i].last
    print "Average: ", oneavg
